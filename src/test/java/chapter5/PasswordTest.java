...
public class PasswordTest extends BaseTest {
	...
	public void testHashedCredentialsMatcherWithMyRealm2() {
		...
		login("classpath:chapter5/shiro-hashedCredentialsMatcher.ini", "liu",
				"123");
	}
	...
	public void testHashedCredentialsMatcherWithJdbcRealm() {
		...
		// 使用testGeneratePassword生成的散列密码
		login("classpath:chapter5/shiro-jdbc-hashedCredentialsMatcher.ini",
				"liu", "123");
	}
	...
	public void testRetryLimitHashedCredentialsMatcherWithMyRealm() {
		for (int i = 1; i <= 5; i++) {
			try {
				login("classpath:chapter5/shiro-retryLimitHashedCredentialsMatcher.ini",
						"liu", "234");
			} catch (Exception e) {/* ignore */
			}
		}
		login("classpath:chapter5/shiro-retryLimitHashedCredentialsMatcher.ini", "liu",
				"234");
	}
